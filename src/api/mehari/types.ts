...
export enum SeqvarConsequence {
  ...
  FrameshiftElongation = 'frameshift_elongation',
  FrameshiftTruncation = 'frameshift_truncation',
  StopLost = 'stop_lost',
  ...
  SelenocysteineGain = 'selenocysteine_gain',
  SelenocysteineLoss = 'selenocysteine_loss',
  // low impact
  SpliceDonorFifthBaseVariant = 'splice_donor_5th_base_variant',
  SpliceRegionVariant = 'splice_region_variant',
  ExonicSpliceRegionVariant = 'exonic_splice_region_variant',
  SpliceDonorRegionVariant = 'splice_donor_region_variant',
  SplicePolypyrimidineTractVariant = 'splice_polypyrimidine_tract_variant',
  ...
  FivePrimeUtrExonVariant = '5_prime_UTR_exon_variant',
  FivePrimeUtrIntronVariant = '5_prime_UTR_intron_variant',
  FivePrimeUtrVariant = '5_prime_UTR_variant',
  ThreePrimeUtrExonVariant = '3_prime_UTR_exon_variant',
  ThreePrimeUtrIntronVariant = '3_prime_UTR_intron_variant',
  ...
  CodingTranscriptIntronVariant = 'coding_transcript_intron_variant',
